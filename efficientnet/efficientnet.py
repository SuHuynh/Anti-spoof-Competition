...
class EfficientNet(nn.Module):
    ...
    def __init__(self, width_mult=1.0, depth_mult=1.0, dropout_rate=0.2, num_classes=60):
        ...
        # Attention Maps
        self.attentions = BasicConv2d(last_channels, 32, kernel_size=1)

        # Bilinear Attention Pooling
        self.bap = BAP()

        # Classification Layer
        self.fc = nn.Linear(32*last_channels, num_classes, bias=False)
